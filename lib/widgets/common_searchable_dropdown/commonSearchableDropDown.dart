...
class DropdownFormField<T> extends StatefulWidget {
  ...
  ///
  final Widget Function(T item, int position, bool focused, bool selected,
      Function() onTap, int index) dropdownItemFn;
...
class DropdownFormFieldState<T> extends State<DropdownFormField>
  ...
  Widget build(BuildContext context) {
    _displayItem = widget.displayItemFn(_selectedItem);
    Future.delayed(Duration.zero).then((value) async =>hintValue=await CommonController.to.getTranslateKeyword(widget.hint.toString()) );
