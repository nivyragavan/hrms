...
import '../screen/on_boarding/task_details_screen.dart';
import 'back_to_screen.dart';
import 'circular_progress_indicator_widget.dart';
import 'common_alert_dialog.dart';
import 'common_button.dart';

class OnBoardingExpansionTileWidget extends StatefulWidget {
  ...
  final ImageProvider<Object>? onBoardingImage;
  final String? templateName;
  final int? taskLength;
  const OnBoardingExpansionTileWidget(
      {Key? key,
        required this.title,
        ...
        this.templateName,  this.taskLength})
      : super(key: key);

  @override
  State<OnBoardingExpansionTileWidget> createState() =>
      _OnBoardingExpansionTileWidgetState();
}

class _OnBoardingExpansionTileWidgetState
    extends State<OnBoardingExpansionTileWidget> {
          ...
          trailing: SizedBox(
            ...
            child: Center(
              child: CircularProgressIndicatorWidget(
                totalSteps: OnBoardingChecklistController
                    .to
                    ...
                    .totalStep ??
                    0,
                currentStep: OnBoardingChecklistController
                    .to
                    .checklistAssignListModel
                    ?.data
                    ?.data![widget.mainIndex]
                ...
                children: [
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      var assignedTaskList = OnBoardingChecklistController
                          .to.checklistAssignListModel?.data?.data?[widget.mainIndex];
                      return SingleChildScrollView(
                          child: InkWell(
                              onTap: () {
                                (index == 0) && (widget.taskLength != OnBoardingChecklistController
                                    .to
                                    .checklistAssignListModel!
                                    .data!
                                    .data![widget.mainIndex]
                                        ...
                                        onPressed: (context) {
                                          commonAlertDialog(
                                            ...
                                            onPressed: () async {
                                              ...
                                              await OnBoardingChecklistController.to.deleteTask(assignedTaskList!
                                                  .template!.task![index]);
                                              ...
                                              SizedBox(
                                                ...
                                                child: ListTile(
                                                  leading: CircleAvatar(
                                                    backgroundImage: assignedTaskList
                                                        .hr!
                                                        .profileImage ==
                                                        null
                                                        ? Image.asset(
                ...
                children: [
                  Expanded(
                    child: CommonButton(
                      ...
                      onPressed: () {
                        OnBoardingChecklistController.to
