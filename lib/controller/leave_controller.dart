...
class LeaveController extends GetxController {
  static LeaveController get to => Get.put(LeaveController());
  ...
  getLeaveHistory() async {
    showList = true;
    // fromDateFilter.text = "2023-08-06";
    // toDateFilter.text = "2023-08-06";
    var body = {"from_date": fromDateFilter.text,"to_date": toDateFilter.text,"request_type": "leave"};
