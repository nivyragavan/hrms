...
class Attachment extends StatelessWidget {
  ...
  getImageList(){
    return  Expanded(
      child:
      AdminAssetController.to.adminAssetsListModel?.data?.data?[AdminAssetController.to.selectedIndex].attachment==""||
      AdminAssetController.to.adminAssetsListModel?.data?.data?[AdminAssetController.to.selectedIndex].attachment==[]?NoRecord():
          ListView.builder(
          shrinkWrap: true,
          itemCount:2,// AdminAssetController.to.adminAssetsListModel?.data?.data?[AdminAssetController.to.selectedIndex].attachment?.length??0,//attachment
