...
import 'package:dreamhrms/screen/on_boarding/on_boarding_template/add_task_screen.dart';
import 'package:dreamhrms/screen/on_boarding/on_boarding_template/edit_task_screen.dart';
...
class DetailedOnBoardingTemplateScreen extends StatelessWidget {
  final Datum templateListModel;
  const DetailedOnBoardingTemplateScreen(
          ...
          children: [
            Row(
              children: [
                InkWell(
                  onTap: () {
                    Get.offAll(OnBoardingTemplateScreen());
                  },
                                  ...
                                  onPressed: (context) {
                                    commonAlertDialog(
                                      ...
                                      onPressed: () async {
                                        ...
                                        await OnBoardingController.to.deleteTask(templateListModel.task![index]);
  ...
  onBoardingDetailsBottomSheet(int index) {
    return Get.bottomSheet(SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          children: [buildOnBoardingDetailsInformation(index)],
        ),
      ),
    ));
  }

  buildOnBoardingDetailsInformation(int index) {
    return StatefulBuilder(
      ...
      return Column(
        ...
        children: [
          ...
          CustomText(
              text: templateListModel.task![index].taskName.toString(),
              color: AppColors.black,
              fontSize: 12,
              fontWeight: FontWeight.w400),
          const SizedBox(
          ...
          CustomText(
              text: templateListModel.task![index].assignRole.toString(),
              color: AppColors.black,
              fontSize: 12,
              fontWeight: FontWeight.w400),
          const SizedBox(
          ...
          CustomText(
              text:
                  "${templateListModel.task![index].noOfDays.toString()} days ${templateListModel.task![index].dueDate.toString()} joining date",
              color: AppColors.black,
              fontSize: 12,
              fontWeight: FontWeight.w400),
          const SizedBox(
  ...
  deleteDialogBox(Task deleteIndex) {
        ...
        content: Container(
          ...
          child: Column(
            children: [
              ...
              CustomText(
                  text: 'all_details_in_this_task_will_be_deleted.',
                  color: AppColors.grey,
                  fontSize: 14,
                ...
                children: [
                  Expanded(
                    child: CommonButton(
                      ...
                      fontWeight: FontWeight.w500,
                      onPressed: () {
                        OnBoardingController.to.deleteTask(deleteIndex);
                      },
                    ),
                  ),
                ],
