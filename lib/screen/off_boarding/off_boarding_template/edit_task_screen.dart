...
class EditTaskScreen extends StatelessWidget {
  ...
  EditTaskScreen({Key? key, required this.templateListModel, required this.taskListModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    Future.delayed(Duration.zero).then((value) async{
      ...
      await OffBoardingController.to.setEditTaskInfo(taskListModel);
      if (OffBoardingController.to.maximumFileNumber != null) {
        try {
          OffBoardingController.to.initialValue = int.parse(OffBoardingController.to.maximumFileNumber.text);
        } catch (e) {
          print("Error parsing maximumFileNumber: $e");
        }
      }
      OffBoardingController.to.showType == false;
    });
    return Scaffold(
      appBar: AppBar(
        centerTitle: false,
          ...
          return Padding(padding: EdgeInsets.all(20),
            child: Form(
              ...
              child: commonLoader(
                length: 6,
                singleRow: true,
                loader: OffBoardingController.to.showType,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MainSearchableDropDown(
                          ...
                          isRequired: true,
                          error: "task_type",
                          items: OffBoardingController.to.taskTypeModel?.data?.data
                              ?.map((type) {
                            return {
                              "task_type": type.type,
                          ...
                          onChanged: (data) async {
                            ...
                            } else if (OffBoardingController.to.taskTypeId.text ==
                                "2") {
                            ...
                            SizedBox(
                              ...
                              child: Center(
                                child: NumberInputWithIncrementDecrement(
                                  controller:
                                  OffBoardingController.to.maximumFileNumber,
                                  initialValue: OffBoardingController.to.initialValue,
                                  min: 0,
                                  max: 10,
                                  textAlign: TextAlign.left,
                      ...
                      MainSearchableDropDown(
                          ...
                          isRequired: true,
                          error: "assign_role",
                          items: OffBoardingController.to.taskRoleModel?.data?.data?.map((type) {
                            return {
                              "assign_role": type.type
                            };
                          }).toList(),
                            ...
                            child: CommonButton(
                              ...
                              onPressed: () async{
                                if (formKey.currentState!.validate()) {
                                  ...
                                  if (taskListModel.taskType == "custom_field") {
                                    await OffBoardingController.to.editTask(
