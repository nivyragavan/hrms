...
class TaskDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.delayed(Duration(milliseconds: 1)).then((value) async {
      ...
      print("sign up ${PersonalController.to.employeeMasterModel?.data}");
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Obx(() => ProvisionsWithIgnorePointer(
          ...
          child: Form(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  CustomText(
                      text: taskDetails.template?.task?[currentIndex].taskName ??
                          "-",
                      color: AppColors.black,
                      fontSize: 16,
                      fontWeight: FontWeight.w600),
                    ...
                    children: [
                      ...
                      CustomText(
                          text: DateFormat('dd-MM-yyyy').format(getDueDate(
                            dueDate:
                                taskDetails.template?.task?[currentIndex].dueDate,
                            days: taskDetails
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          CircleAvatar(
                            radius: 15,
                            backgroundImage: taskDetails.hr!.profileImage == null
                                ? Image.asset('assets/images/user.jpeg').image
                  ...
                  CustomText(
                      text:
                          taskDetails.template?.task?[currentIndex].description ??
                              "-",
                      color: AppColors.grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w400),
                        ...
                        child: CommonButton(
                          ...
                          onPressed: () async{
                            ...
                            if (taskDetails
                                ...
                                "custom_field"){
                              for (int i = 0;
                                  i < OffBoardingController.to.customField.length;
                                  i++) {
                                taskDetailsModel.taskDetails.insert(
                                    i,
                                    TaskDetails(
                                        id: taskDetails.template
                                            ?.task?[currentIndex].taskForm?[i].id,
                                        fieldType: taskDetails.template
                                            ?.task?[currentIndex].taskForm?[i].fieldType,
                                        answer: OffBoardingController
                                            .to.customField[i].text));
                              }
                              await OffBoardingChecklistController.to.userTaskAnswer(
                            ...
                            if (taskDetails
                                ...
                                "file") {
                              for (int i = 0;
                                  i < OffBoardingController.to.document.length;
                                  i++) {
                                taskDetailsModel.taskDetails.insert(
                                    i,
                                    TaskDetails(
                                        id: taskDetails.template
                                            ?.task?[currentIndex].taskForm?[0].id,
                                        fieldType: taskDetails.template
                                            ?.task?[currentIndex].taskForm?[0].fieldType,
                                        answer: OffBoardingController
                                            .to.document[i].text));
                              }
                              await OffBoardingChecklistController.to.userTaskAnswerFile(
                                  userId: taskDetails.user!.id!,
                                  taskId: taskDetails
                                      .template!.task![currentIndex].id!,
                                  taskDetails: taskDetailsModel.taskDetails,
                            ...
                            if (taskDetails
                              ...
                              if (nextIndex >=
                                ...
                                commonAlertDialog(
                                    ...
                                    title: "complete_offboarding ?",
                                    description:
                                    "do_you_want_to_complete_this_employee's_offboarding ?"
                                        ,
  ...
  taskFile() {
    OffBoardingController.to.documentName = List.generate(
        getOptionsItemCount(), (index) => TextEditingController());
    OffBoardingController.to.document = List.generate(
        getOptionsItemCount(), (index) => TextEditingController());
        ...
        return Column(
          ...
          children: [
            CustomDottedBorder(
              onPressed: () async {
                await pickFiles(
                  loader: OffBoardingController.to.loader,
                  controller: OffBoardingController.to.documentName[index],
                  binary: OffBoardingController.to.document[index],
                  key: "Document",
                );
              },
            ),
            ...
            Obx(() {
              return CommonController.to.fileLoader == true
                  ? SizedBox()
                  : CustomText(
                      text: OffBoardingController.to.documentName[index].text,
  ...
  taskCustomField() {
    OffBoardingController.to.customField = List.generate(
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        print('field type ${formDetails!.fieldType}');
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            if (formDetails!.fieldType == "text")
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  CommonTextFormField(
                    controller: OffBoardingController.to.customField[index],
                    isBlackColors: true,
                  ...
                  Obx(
                    () => PersonalController.to.masterLoader ||
                        ...
                        : MainSearchableDropDown(
                            ...
                            controller:
                                OffBoardingController.to.customField[index],
                            onChanged: (data) {}),
                  )
                ],
              ),
